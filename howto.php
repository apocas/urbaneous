...
<html lang="en">
    ...
    <body>
        ...
        <section style="height:300px;" class="section_white">
            <div class="section_white_container">
                <div class="section_white_down_top1">
                    <div class="section_white_down_top1_left">
                        <figure>
                            <img style="width:140px;height:auto;" src="images/database.png" alt="database"/>
                        </figure>
                    </div>
                    <div class="section_white_down_top1_right">
